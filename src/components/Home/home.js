...
export default function Home() {
  return <main>
    ...
    <section className="intro section-wrap"><div><p className="eyebrow">WELCOME TO IDEALSOFT</p><h2>A little more<br /><em>than a night out.</em></h2></div><div className="intro-copy"><p>Fresh pours, generous plates and space to slow down. Make us part of your next catch-up, celebration or just-because evening.</p><Link className="text-link" to="/about">Get to know us <span aria-hidden="true">↗</span></Link></div></section>
